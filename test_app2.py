...
#     # Mock response with different states
#     response = {
...
#                 'buttons': ['Check status', 'Submit concern'],
#                 'text_area': None,
#                 'text_field': None,
#                 'data': {
...
def on_file_upload(message_index):
    ...
    #     files = [file.name for file in st.session_state.uploaded_files]
    #     # Add file upload information to history
    #     st.session_state.history.append(Message("human", f"Uploaded files: {', '.join(files)}"))
        
    #     # Process the file upload through the backend
    #     # In a real implementation, you would handle file uploads properly
    #     response = process_state(files=files)        
